...
function ProductLeftbar() {
    ...
    return (
        <Box p="0 15px">
            <div style={{backgroundColor:"#ffffff"}} m="10px">
            
            <VStack spacing={[1, 3]} direction={['column', 'row']}>
                <Flex>
                <Box>Quick Filters</Box><Spacer/>
                <Box>+</Box>
                </Flex>
            ...
            <Flex>
            <Box>Cuisines</Box><Spacer/>
            <Box>+</Box>
            </Flex>
            <VStack spacing={[1, 3]} direction={['column', 'row']}>
                <Input  variant='filled' placeholder='Search' p="0 10px" m="10px"/>
                <Box>North Indian</Box>
                <Box>Fast Food</Box>
                <Box>Chinese</Box>
                <Box>Italian</Box>
                <Box>Show More</Box>
